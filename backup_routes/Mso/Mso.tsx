...
const Mso: FC = () => (
   <SidebarLayout>
          ...
          <div className="relative lg:ml-10">
            ...
            <blockquote className="relative">
              <div className="text-2xl font-medium leading-9 text-gray-900">
                <p>
                  Возникли вопросы с расписанием - обращайтесь к зав. отделением стоматологии
                </p>
              </div>
              <footer className="mt-8">
                <div className="flex">
                  ...
                  <div className="ml-4 lg:ml-0">
                    <div className="text-base font-medium text-gray-900">Пучкова Ольга Ильинична</div>
                    <div className="text-base font-medium text-sky-900">Зав. отделением стоматологии</div>
                  </div>
                </div>
              </footer>
            </blockquote>
    ...
    <iframe width="100%" height="1060"  src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSUWkggUMgumgiG83x0q7RlZoKN902OiRz-JI7JyQXOCl_SB-GIlsQjr2kjkj4F-WjKo8RcfrLg-zjc/pubhtml?widget=true&amp;headers=false"></iframe>
   </SidebarLayout>
)
