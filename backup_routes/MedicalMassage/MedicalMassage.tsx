...
const products = [
   {
     id: 1,
     name: '1. Соблюдать санитарно-гигиенических требования, предъявляемых к организации работы кабинета массажа, рабочего места массажиста.     ',
     href: '#',
   ...
   {
      id: 2,
      name: '2. Следить  за состоянием пациентов во время проведения процедур.      ',
   },
   {
      id: 3,
      name: '3. Проведение  всех видов массажа.      ',
   },
   {
      id: 4,
      name: '4. Использование частных методик массажа при различных заболеваниях, в послеоперационный период восстановительного лечения в хирургии.      ',
   },
   {
      id: 5,
      name: '5. Использование методик детского массажа, физических упражнений в раннем детском возрасте.      ',
   },
   {
      id: 6,
      name: '6. Сочетание массажа с лечебной физкультурой, физиотерапевтическими процедурами, вытяжением, мануальной терапией.      ',
   },
   {
      id: 7,
      name: '7. Соблюдение требований использования медицинского оборудования, охраны труда, техники безопасности, гигиены труда, противопожарной безопасности при эксплуатации помещений.      ',
   },
   {
      id: 8,
      name: '8. Обеспечение инфекционной безопасности всего контингента учреждения, выполнение противоинфекционных мероприятий в массажном кабинете.      ',
   },
   {
      id: 9,
      name: '9. Своевременное и качественное ведение медицинской документации.      ',
   },
   {
      id: 10,
      name: '10. Соблюдение морально-правовых норм общения, выполнение требований трудовой дисциплины.      ',
   },
   {
      id: 11,
      name: '11. Проведение санитарно-просветительной работы.      ',
   },
   {
      id: 12,
      name: '12. Регулярное повышение квалификации      ',
   },
   {
      id: 13,
      name: '13. Оказание доврачебной помощи.      ',
   },
]
   const people = [
      {
        ...
        <div>
          <div className="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
            <div className="lg:col-start-2">
              <p className="mt-2 text-2xl font-bold tracking-tight text-sky-900 sm:text-3xl">Медицинский массаж</p>
