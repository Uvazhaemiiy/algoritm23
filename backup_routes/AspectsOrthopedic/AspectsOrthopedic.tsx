...
const products = [
   {
     id: 1,
     name: '1. Изготавливать съемные пластиночные протезы при частичном  отсутствии зубов.     .',
     href: '#',
   },
   {
      id: 2,
      name: '2. Изготавливать съемные  пластиночные протезы при полном отсутствии зубов.      ',
   },
   {
      id: 3,
      name: '3. Производить починку съемных пластиночных протезов.      ',
   },
   {
      id: 4,
      name: '4. Изготавливать съемные иммедиат-протезы.      ',
   },
   {
      id: 5,
      name: '5. Изготавливать пластмассовые коронки и мостовидные протезы.      ',
   },
   {
      id: 6,
      name: '6. Изготавливать штампованные металлические коронки и штампованно-паяные мостовидные протезы.      ',
   },
   {
      id: 7,
      name: '7. Изготавливать культевые штифтовые вкладки.      ',
   },
   {
      id: 8,
      name: '8. Изготавливать цельнолитые коронки мостовидные зубные протезы.      ',
   },
   {
      id: 9,
      name: '9.  Изготавливать цельнолитые коронки мостовидные зубные протезы с облицовкой.      ',
   },
   {
      id: 10,
      name: '10. Изготавливать литые бюгельные зубные протезы с кламмерной системой фиксации.      ',
   },
   {
      id: 11,
      name: '11. Изготавливать основные элементы ортодонтических аппаратов.      ',
   },
   {
      id: 12,
      name: '12. Изготавливать основные съемные и несъемные ортодонтические аппараты.      ',
   },
   {
      id: 13,
      name: '13. Изготавливать основные виды челюстно-лицевых аппаратов при дефектах челюстно-лицевой области.      ',
   },
   {
      id: 14,
      name: '14. Изготавливать лечебно-профилактические челюстно-лицевые аппараты (шины).      ',
   },
]
   const people = [
      {
        ...
        <div>
          <div className="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
            <div className="lg:col-start-2">
              <p className="mt-2 text-2xl font-bold tracking-tight text-sky-900 sm:text-3xl">Современные аспекты ортопедической помощи населению</p>
              ...
              <li>Категория слушателей: старший зубной техник, зубной техник.</li>
...
export default AspectsOrthopedic
