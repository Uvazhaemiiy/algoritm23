...
const products = [
   {
     id: 1,
     name: '1. Проводить мероприятия по сохранению и укреплению здоровья населения, пациента и  его окружения.',
     href: '#',
   ...
   {
      id: 2,
      name: '2. Проводить санитарно-гигиеническое воспитание населения.',
   },
   {
      id: 3,
      name: '3. Участвовать в проведении профилактики инфекционных и неинфекционных заболеваний.',
   },
   {
      id: 4,
      name: '4. Представлять информацию в понятном для пациента виде, объяснять ему суть вмешательств.',
   },
   {
      id: 5,
      name: '5. Осуществлять лечебно-диагностические вмешательства, взаимодействуя с участниками лечебного процесса.',
   },
   {
      id: 6,
      name: '6. Сотрудничать со взаимодействующими организациями и службами.',
   },
   {
      id: 7,
      name: '7. Применять медикаментозные средства в соответствии с правилами их использования.',
   },
   {
      id: 8,
      name: '8. Соблюдать правила использования аппаратуры, оборудования и изделий медицинского назначения в ходе лечебно-диагностического процесса.      ',
   },
   {
      id: 9,
      name: '9. Вести утвержденную медицинскую документацию.',
   },
   {
      id: 10,
      name: '10. Осуществлять реабилитационные мероприятия.',
   },
   {
      id: 11,
      name: '11. Оказывать паллиативную помощь.',
   },
   {
      id: 12,
      name: '12. Проводить диагностику неотложных состояний.',
   },
   {
      id: 13,
      name: '13. Определить тактику ведения пациента.',
   },
   {
      id: 14,
      name: '14. Взаимодействовать с членами профессиональной бригады и добровольными помощниками в условиях чрезвычайных ситуаций.',
   },
]
   const people = [
      {
        ...
        <div>
          <div className="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
            <div className="lg:col-start-2">
              <p className="mt-2 text-2xl font-bold tracking-tight text-sky-900 sm:text-3xl">Проведения предрейсовых медосмотров водителей автотранспортных средств</p>
              <p className="mt-4 text-xl text-gray-800">
              Усовершенствование профессионализма имеющейся квалификации
              </p>
              <ul
                role="list"
              ...
              <li>Категория слушателей: медицинская сестра, фельдшер</li>
              <li>Форма обучения: очная.</li>
              <li>Трудоемкость программы: 72 час.</li>
              <li>Сроки освоения программы:  9 календарных дней.</li>
