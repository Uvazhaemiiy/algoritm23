...
const posts = [
   {
     ...
     href: '/medical-examinations',
     imageUrl:
       '/images/windows/medical-examinations-drivers.jpg',
   },
   {
     title: 'Современные методы клинических исследований в лабораторной диагностике',
     href: '/laboratory-diagnostics',
     imageUrl:
       '/images/windows/clinical-researches.jpg',
   },
   {
     title: 'Современные аспекты ортопедической помощи населению',
     href: '/aspects-orthopedic',
     imageUrl:
       '/images/windows/orthopedic-care.jpg',
   },
   {
      title: 'Медицинский массаж',
      href: '/medical-massage',
      imageUrl:
        '/images/windows/massage.jpg',
    },
    {
      title: 'Современные аспекты сестринского дела в анестезиологии и реаниматологии',
      href: '/anaesthesiology-and-resuscitation',
      imageUrl:
        '/images/windows/anesthesiology-resuscitation.jpg',
    },
    {
      title: 'Сестринское дело в стоматологии',
      href: '/nursing-in-dentistry',
      imageUrl:
        '/images/windows/nursing-dentistry.jpg',
    },
    {
      title: 'Сестринское дело в хирургии',
      href: '/nursing-in-surgery',
      imageUrl:
        '/images/windows/nursing-in-surgery.jpg',
    },
    {
      title: 'Сестринское дело в терапии',
      href: '/nursing-in-therapy',
      imageUrl:
        '/images/windows/nursing-therapy.jpg',
    },
    {
      title: 'Охрана здоровья работников промышленных и других предприятий',
      href: '/health-protection',
      imageUrl:
        '/images/windows/workers-health.jpg',
    },
 ]
 //Blog Feed - end
