...
const Gia: FC = () => (
   <SidebarLayout>
        ...
        <div className="relative lg:flex lg:items-center">
          <div className="hidden lg:block lg:flex-shrink-0">
            <img
              ...
              src="/images/staff/Kuratseva.png"
              alt=""
            />
          </div>
          ...
          <div className="relative lg:ml-10">
            ...
            <blockquote className="relative">
              <div className="text-2xl font-medium leading-9 text-gray-900">
                <p>
                  Возникли вопросы с расписанием - обращайтесь к зам. директора по УР, кабинет №2
                </p>
              </div>
              <footer className="mt-8">
                <div className="flex">
                  ...
                  <div className="ml-4 lg:ml-0">
                    <div className="text-base font-medium text-gray-900">Куратцева Ирина Николаевна</div>
                    <div className="text-base font-medium text-sky-900">Заместитель директора по УР</div>
                  </div>
                </div>
              </footer>
            </blockquote>
    ...
    <iframe width="100%" height="660"  src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTT0Wd56he_2cOAqBCjLu1hpckMiPA5_6nosxDJJpHbD8DvZNSgCZ9y1fIizactdfaqmFTZwsus0YA3/pubhtml?widget=true&amp;headers=false"></iframe>
   </SidebarLayout>
)
