        ...
        <div>
          <div className="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
            <div className="lg:col-start-2">
              <p className="mt-2 text-2xl font-bold tracking-tight text-sky-900 sm:text-3xl">Группа МСД-313</p>
              <p className="mt-4 text-xl text-gray-800">
              Полный состав группы и отвественный куратор
              </p>
              <iframe className="mt-6" height="686" width="100%" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSS5UMaV6fGELKC-ChkHxX6rkoGwJ122pQqvOk0t3erLdm0N6EKXO94nETRy9PpD-EGFqeumCL9Ru8d/pubhtml?gid=1414644654&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
