...
const products = [
   {
     ...
     imageAlt: "Современные аспекты сестринского дела в анестезиологии и реаниматологии",
   },
   {
      id: 2,
      name: '2. Информировать пациента доступным для понимания языком, объяснять потребность вмешательства.',
   },
   {
      id: 3,
   ...
   {
      id: 4,
      name: '4. Совместно работать с предприятиями.',
   },
   {
      id: 5,
        ...
        <div>
          <div className="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
            <div className="lg:col-start-2">
              <p className="mt-2 text-2xl font-bold tracking-tight text-sky-900 sm:text-3xl">Современные аспекты сестринского дела в анестезиологии и реаниматологии</p>
...
export default AnaesthesiologyResuscitation
